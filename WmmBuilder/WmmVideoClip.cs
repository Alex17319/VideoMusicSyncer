...
{
	public class WmmVideoClip : WmmExtent
	{
		public override string XmlElementName => "VideoClip";

		protected override XE BoundProperties => new XE(
			"BoundProperties",
			new XE("BoundPropertyBool", new XA("Name", "Mute"), new XA("Value", "false")),
			new XE("BoundPropertyInt", new XA("Name", "rotateStepNinety"), new XA("Value", "0")),
		...
		public WmmVideoClip(int extentID, int mediaItemID, double inTime, double outTime, double speed)
			: base(extentID)
		{
